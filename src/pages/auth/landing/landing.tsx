          ...
          <div className="grid grid-cols-2 pt-12 pb-24 grid-flow-col">
            <div className="col-span-1 relative pt-8">
              ...
              <p className="mt-4 mb-8 lg:mb-16 font-normal text-slate-800 text-md tracking-wide leading-12">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi asperiores aut, consectetur dolores
                eaque eveniet excepfont-bold tracking-tight leading-tightturi exercitationem id, libero maxime minima
                neque nihil non nulla quae, quod reprehenderit ut voluptatibus!
              </p>
